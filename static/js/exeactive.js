var settings = {
  "async": true,
  "crossDomain": true,
  "url":             "http://127.0.0.1:5000/activetrendnew",
  "method": "GET"
 }
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://127.0.0.1:5000/practicehistorychart",
    "method": "GET"
  }
  $.ajax(settings).done(function (response) {
    var dataa = JSON.parse(response);
  ...
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://127.0.0.1:5000/practicehistorychartlatest",
    "method": "GET"
  }
  $.ajax(settings).done(function (response) {
    var dataa = JSON.parse(response);
