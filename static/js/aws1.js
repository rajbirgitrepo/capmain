$(document).ready(function(){
    ...
    var dashboard_name = document.getElementById('aws_dashboard').innerText;
...
$.ajax(settings).done(function(response) {
    ...
    var chart = Highcharts.stockChart('container9', {
        ...
        series: [{
            // color: '#01a451',
            // name: 'Releases',
            data: dataa.releases.AWS_FEATURES, //Fri, 14 Jul 2017 00:00:00 GMT
            dataGrouping: {
                enabled: false,
            }
        }]
...
$.ajax(settings).done(function(response) {
    ...
    chart = new Highcharts.StockChart({
        ...
        series: [{
            ...
            "color": "#FF9933",
            "xAxis": 0,
            "data": dataa.playback.cost_per_playback,
            yAxis: 1
        }, {
            "name": "Family",
            "type": "column",
        ...
        },
         {
            ...
            "xAxis": 1,
            "color": "#4bbf5b",
            "data": dataa.playback.Clever_Playback
        },
         {
            "name": "Schoology",
            "type": "column",
            "xAxis": 1,
            "color": "#462cee",
            "data": dataa.playback.Schoology_Playback
        },
         {
            "name": "Canvas",
            "type": "column",
            "xAxis": 1,
            "color": "#4f1faf",
            "data": dataa.playback.Canvas_Playback
        },
    ]
    });
});
...
$.ajax(settings).done(function(response) {
    ...
    $(function() {
        $("#container1").highcharts({
            ...
            xAxis: [{
                categories: dataa.data.Month_Name,
                labels: {
                    rotation: 0
                }
            }],
...
$.ajax(settings).done(function(response) {
    ...
    $(function() {
        $("#container2").highcharts({
            ...
            xAxis: [{
                categories: dataa.data.End_User.Month_Name,
                labels: {
                    rotation: 0
                }
            }],
...
$.ajax(settings).done(function(response) {
    ...
    $(function() {
        $("#container3").highcharts({
            ...
            xAxis: [{
                categories: dataa.data.End_User_Stat.Month_Name,
                labels: {
                    rotation: 0
                }
            }],
...
$.ajax(settings).done(function(response) {
    ...
    $(function() {
        $("#container5").highcharts({
            ...
            xAxis: [{
                categories: dataa.data.App_Server.Month_Name,
                labels: {
                    rotation: 0
                }
            }],
...
$.ajax(settings).done(function(response) {
    ...
    $(function() {
        $("#container6").highcharts({
            ...
            xAxis: [{
                categories: dataa.data.App_Server_Stat.Month_Name,
                labels: {
                    rotation: 0
                }
            }],
...
$.ajax(settings).done(function(response) {
    ...
    $(function() {
        $("#container7").highcharts({
            ...
            xAxis: [{
                categories: dataa.data.Collection_Name,
                labels: {
                    rotation: 0
                }
            }],
...
$.ajax(settings).done(function(response) {
    ...
    $(function() {
        $("#container11").highcharts({
            ...
            xAxis: [{
                categories: dataa.data.table_name,
                labels: {
                    rotation: 0
                }
            }],
