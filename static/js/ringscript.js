...
{  var settings = {
  ...
  $.ajax(settings).done(function (response) {
    ...
    console.log("hello22");
    console.log(dataa.engaged);
    $("#schoolcountdistrict").text(dataa.totalschool);
    $("#active2").text(dataa.engaged);
    $("#passive2").text(dataa.onboarding);
    $("#dormant2").text(dataa.intervention);

    $("#usercount2").text(dataa.usercount);
    $("#power2").text(dataa.power);
    $("#active3").text(dataa.active);
    $("#passive3").text(dataa.passive);
    $("#dormant3").text(dataa.dormant);
    $("#sl").text(dataa.schoology);
    $("#cl").text(dataa.clever);
  });
};
