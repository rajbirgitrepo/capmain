var modal = document.getElementById("myModal");
  function searchmain(a){
    URL = "http://127.0.0.1:5000/donationjourney/"+a
    console.log(URL)
    $("#schoolname").empty();;
    $("#email").empty();
    $("#lastd").empty();
      ...
      series: {point: {
                events: {
                    click: function () {
                     ...
                     URL = 'http://127.0.0.1:5000/donationhistorytable/'+a ;
          console.log(URL);               
          $("#next").empty();
          $("#btnExport").show();
          console.log(URL);
...
var settings = {
  async: true,
  crossDomain: true,
  url: "http://127.0.0.1:5000/donationcards",
  method: "GET",
};
$.ajax(settings).done(function (response) {
  var dataa = JSON.parse(response);
...
var settings = {
  async: true,
  crossDomain: true,
  url: "http://127.0.0.1:5000/newdonor",
  method: "GET",
};
$.ajax(settings).done(function (response) {
  var dataa = JSON.parse(response);
...
var settings = {
  async: true,
  crossDomain: true,
  url: "http://127.0.0.1:5000/boardmemberdonation/",
  method: "GET",
};
$.ajax(settings).done(function (response) {
  var dataa = JSON.parse(response);
...
var settings = {
  async: true,
  crossDomain: true,
  url: "http://127.0.0.1:5000/donationmapcard",
  method: "GET",
};
$.ajax(settings).done(function (response) {
  var dataa = JSON.parse(response);
  ...
  $("#0c").text("$" + dataa.data[0][1].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
  $("#1c").text("$" +dataa.data[1][1].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
  $("#2c").text("$" + dataa.data[2][1].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
  $("#3c").text("$" +dataa.data[3][1].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
  $("#4c").text("$" +dataa.data[4][1].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
...
var settings = {
  "async": true,
  "crossDomain": true,
  "url":             "http://127.0.0.1:5000/donationcsy",
  "method": "GET"
 }
  $.ajax(settings).done(function (response) {
  var dataa=JSON.parse(response); 
    ...
    series: {point: {
              events: {
                  click: function () {
                   ...
                   URL = 'http://127.0.0.1:5000/donationcsytable/'+a ;
        console.log(URL);               
        $("#next").empty();
        $("#btnExport").show();
        console.log(URL);
...
function charts(a,b){
  ...
  var settings = {
    async: true,
    crossDomain: true,
    url: "http://127.0.0.1:5000/donationcalandercard/"+a + "/" + b,
    method: "GET",
  };
  $.ajax(settings).done(function (response) {
    var dataa = JSON.parse(response);
...
console.log("http://127.0.0.1:5000/donationhistor/"+a + "/" + b);
var settings = {
  "async": true,
  "crossDomain": true,
  "url":             "http://127.0.0.1:5000/donationhistory/"+a + "/" + b,
  "method": "GET"
 }
  $.ajax(settings).done(function (response) {
  var dataa=JSON.parse(response); 
...
var settings = {
  "async": true,
  "crossDomain": true,
  "url":             "http://127.0.0.1:5000/weeklydonation/"+a + "/" + b,
  "method": "GET"
 }
  $.ajax(settings).done(function (response) {
  var dataa=JSON.parse(response);
...
tooltip: {
    ...
    var settings = {
      "async": true,
      "crossDomain": true,
      "url":             "http://127.0.0.1:5000/donationCrowdfundingcsy",
      "method": "GET"
     }
      $.ajax(settings).done(function (response) {
      var dataa=JSON.parse(response); 
        ...
        series: {point: {
                  events: {
                      click: function () {
                       ...
                       URL = 'http://127.0.0.1:5000/donationCrowdfundingcsytable/'+a ;
            console.log(URL);               
            $("#next").empty();
            $("#btnExport").show();
            console.log(URL);
